(function() {
		var h = {}
			, mt = {}
			, c = {
			id: "bc5920843408306f8b6fc088319384ce",
			dm: ["pan.baidu.com/doc"],
		...
		mt.cookie.set = function(a, b, g) {
			...
			document.cookie = a + "=" + b + (g.domain ? "; domain=" + g.domain : "") + (g.path ? "; path=" + g.path : "") + (d ? "; expires=" + d.toGMTString() : "") + (g.Jc ? "; secure" : "")
		}
		;
		...
		(function() {
					...
					try {
						...
						for (a = 0; e && a < d.length; ) {
							...
							if (!("html" === l || "body" === l)) {
								...
								for (p = 0; p < e.childNodes.length; p++)
									1 === e.childNodes[p].nodeType && e.childNodes[p].nodeName.toLowerCase() === l && f.push(e.childNodes[p]);
								if (!f[b])
									return w;
								e = f[b]
							}
				...
				mt.f.wa = function(a, d) {
					...
					for (; a.parentNode != w; ) {
						...
						if ((n = "" !== a.id) && d) {
							...
							n && (n = "#" + encodeURIComponent(a.id),
								n = 0 < e.length ? n + ">" + e.join(">") : n,
								b.push(n)),
								e.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < f ? "[" + l + "]" : ""));
						a = a.parentNode
					}
					b.push(e.join(">"));
					return b
				...
				mt.f.getAttribute = function(a, d) {
					...
					if (!e && a.attributes && a.attributes.length)
						for (var b = a.attributes, f = b.length, l = 0; l < f; l++)
							b[l].nodeName === d && (e = b[l].nodeValue);
					return e
				}
				;
				mt.f.T = function(a) {
				...
				mt.f.S = function(g, d) {
					...
					a.H(g) && 0 === String(g).indexOf("!HMCQ!") ? (e = String(g),
						...
						"input" === e && d && ("button" === g.type || "submit" === g.type) ? e = a.trim(g.value) || "" : "input" === e && !d && "password" !== g.type ? e = a.trim(g.value) || "" : "img" === e ? (e = mt.f.getAttribute,
							e = e(g, "alt") || e(g, "title") || e(g, "src")) : e = "body" === e || "html" === e ? ["(hm-default-content-for-", e, ")"].join("") : mt.f.Tb(g));
		...
		mt.localStorage.set = function(a, b, g) {
			...
			try {
				window.localStorage ? (b = d.getTime() + "|" + b,
					window.localStorage.setItem(a, b)) : mt.localStorage.ma() && (mt.localStorage.l.expires = d.toUTCString(),
					...
					ca: function(d, e) {
						...
						if (!a.d(b, "Undefined")) {
							...
							if (a.d(b, "Object")) {
								var f = [], l;
								for (l in b)
									b.hasOwnProperty(l) && g.$a(l, e) && (f = f.concat(b[l]));
								return f
							}
						}
					}
				...
				var a = mt.cookie
					...
					da: function() {
						for (var a = 0, b = c.dm.length; a < b; a++) {
							var f = c.dm[a];
							if (-1 < f.indexOf("/") && d.ga(document.location.href, f))
								return f.replace(/^[^/]+(\/.*)/, "$1") + "/"
						}
						return "/"
					}
		...
		(function() {
				var a = mt.lang
					...
					ya: function() {
						for (var a = {}, b, e = r.length - 1; 0 <= e; e--) {
							b = d[r[e]];
							for (var t in b)
								b.hasOwnProperty(t) && (a[t] = b[t])
						}
						return a
					},
					...
					o: function(b) {
						b !== q && ("userId" === b && a.d(d.user, "Object") ? (delete d.user.uid_,
							l.Ia()) : "user" === b && a.d(d.user, "Object") ? (b = d.user.uid_,
							d.user = b === q ? {} : {
								uid_: b
							},
							l.Ia()) : d[b] !== q && (d[b] = {}))
					...
					gc: function(a, b, e) {
						...
						if (256 < encodeURIComponent(String(b)).length || 256 < encodeURIComponent(String(e)).length)
							...
							a = l.O(l.A(a));
							2048 < encodeURIComponent(a).length && (k !== q ? g[b] = k : delete g[b],
								f = x)
						}
						return f
					},
					...
					var f = {
						...
						init: function() {
							for (var a, e = d.ca(c.cptrk) || [], g = 0; g < e.length; g++)
								if (a = e[g],
								a.a !== q && b.d(a.a, "Object")) {
									a = a.a;
									for (var s in a)
										a.hasOwnProperty(s) && (f.ka[s] = String(a[s]))
								}
						},
						bb: function() {
							var b, d, e;
							for (e in f.ka)
								if (f.ka.hasOwnProperty(e) && f.cb[e] === q && (b = f.ka[e],
									b = a.ua(b)))
									d = d === q ? {} : d,
										d[e] = a.S(b, x),
										f.cb[e] = u;
						...
						dc: function() {
							"MutationObserver"in window ? (new MutationObserver(f.Aa)).observe(document.body, {
								childList: u,
								subtree: u
		...
		(function() {
				var a = mt.lang
					...
					ba: function(a, r) {
						return function(f) {
							...
							if (l) {
								...
								if (p && p === f)
									l.removeAttribute(a.la);
								else if (0 < n.length && (l = b.Qb(l)) && l.length)
									if (n = l.length,
										p = l[l.length - 1],
									1E4 > n * p.split(">").length)
										for (p = 0; p < n; p++)
											d.jb(a, l[p]);
									else
										d.jb(a, p)
					...
					jb: function(b, d) {
						for (var f = {}, g = String(d).split(">").length, n = 0; n < g; n++)
							f[d] = "",
								d = d.substring(0, d.lastIndexOf(">"));
						b && (a.d(b, "Object") && b.Sa) && b.Sa(f)
					},
					jc: function(a, b) {
						return function(d) {
				...
				var a = mt.f
					...
					Gb: function(b, e) {
						...
						f && (c.aet && c.aet.length ? (b.ei_ = a.getAttribute(f, g.id) || a.getAttribute(f, "id") || "",
							...
							b.ex_ = a.getAttribute(f, g.$) || a.xa(f),
							b.en_ = a.getAttribute(f, g.content) || a.S(f, u),
							b.et_ = a.getAttribute(f, g.ia) || a.T(f),
							b.el_ = a.getAttribute(f, g.link) || a.getAttribute(f, "href") || "") : (b.ex_ = a.getAttribute(f, g.$) || a.xa(f),
							b.en_ = a.getAttribute(f, g.content) || a.S(f, u)));
						return b
					},
					Rb: function(b, d) {
		...
		(function() {
				var a = mt.lang
					...
					va: function(f, g) {
						...
						"click" === g.type ? m = d.Ca ? g.clientY + Math.max(document.documentElement.scrollTop, document.body.scrollTop) : g.pageY : "touchend" === g.type && (g.ab && g.ab.changedTouches) && (m = g.ab.changedTouches[0].pageY);
						k.uc = m;
						m = this.Jb(g);
						k.Fa = m.Fa || 0;
						k.Ha = m.Ha || 0;
					...
					Jb: function(e) {
						...
						var y = m = 0
							, z = 0
							, A = 0;
						if (f && (m = f.offsetWidth || f.clientWidth,
							y = f.offsetHeight || f.clientHeight,
							A = b.Ob(f),
							z = A.left,
							A = A.top,
						a.d(f.getBBox, "Function") && (y = f.getBBox(),
							m = y.width,
							y = y.height),
						"html" === (f.tagName || "").toLowerCase()))
							m = Math.max(m, f.clientWidth),
					...
					na: function(b) {
						var d = a.h;
						b = [+new Date - (h.c.X !== q ? h.c.X : n), d(b.id), d(b.aa), d(b.ia), d(b.$), d(b.link), d(b.content), b.type, b.uc, b.Fa, b.Ha, b.Na, b.za, b.La].join("*");
						s.oa(b);
						a.d(this.Z(), "Function") && this.Z()()
					},
					oa: function(a) {
						a.length > e.pa || (encodeURIComponent(p.join("!") + a).length > e.pa && (s.w(p.join("!")),
							p = []),
							p.push(a))
					},
					w: function(a) {
				...
				a.H(c.aet) && "" !== c.aet && r.e("pv-b", function() {
					...
					"ontouchend"in document && g.e(window, "touchend", s.ba());
		...
		(function() {
				var a = mt.lang
					...
					Bb: function() {
						return function() {
							h.c && (h.c.V && c.aet && c.aet.length) && (window.clearTimeout(l),
					...
					oa: function(a) {
						if (encodeURIComponent(f.join("!") + a).length > d.pa || 3 < f.length)
							p.w(f.join("!")),
								f = [];
						f.push(a)
					},
		...
		(function() {
				...
				function d(a) {
					if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
						p = "focus" == a.type || "focusin" == a.type ? u : x,
							b()
				}
				var e = mt.event, r = h.z, f = u, l = u, n = u, p = u, s = +new Date, t = s, v = 0, k = u, m = g("visibilityState"), y = g("hidden"), z;
				b();
				(function() {
		...
		(function() {
				...
				var g = mt.url
					...
					_trackPageview: function(a) {
						1 < a.length && (a[1].charAt && "/" === a[1].charAt(0)) && (k.j |= 4,
							h.c.b.sn = h.c.Va(),
							h.c.b.et = 0,
							h.c.b.ep = "",
							h.c.b.vl = r.U() + r.M(),
					...
					_setReferrerOverride: function(a) {
						1 < a.length && (a = a[1],
							d.d(a, "String") ? (h.c.b.su = "/" === a.charAt(0) ? f.protocol + "//" + window.location.host + a : a,
								k.Da = u) : k.Da = x)
					},
					...
					_clearAutoEventTrackingProperty: function(a) {
						1 < a.length && u === a[1] && t.o("autoEventTracking")
					},
					...
					_providePlugin: function(a) {
						if (1 < a.length) {
							var b = window._hmt
								, e = a[1];
							a = a[2];
							if (d.G(f.eb, e) && d.d(a, "Function") && (b.plugins = b.plugins || {},
								b.I = b.I || {},
								b.plugins[e] = a,
								b.B = b.B || [],
								a = b.B.slice(),
		...
		(function() {
				var a = h.z;
				c.spa !== q && "1" === String(c.spa) && (window._hmt = window._hmt || [],
		...
		(function() {
				function a() {
					"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = u,
						...
						this.Ya = this.Xa = u,
						this.V = k.V,
						this.Ra = e.H(c.aet) && 0 < c.aet.length ? c.aet.split(",") : "",
						this.Ba = x,
						this.init())
				}
				var b = mt.url
				...
				a.prototype = {
					...
					da: function() {
						for (var a = 0, b = c.dm.length; a < b; a++) {
							var d = c.dm[a];
							if (-1 < d.indexOf("/") && this.ga(document.location.href, d))
								return d.replace(/^[^/]+(\/.*)/, "$1") + "/"
						}
						return "/"
					},
					Sb: function() {
						...
						var a = x;
						this.ea(document.referrer) && this.ea(document.location.href) ? a = u : (a = b.L(document.referrer),
					...
					rc: function() {
						...
						if (0 === c.nv && this.ea(document.location.href) && ("" === document.referrer || this.ea(document.referrer)))
							a = 0,
								b = 4;
						this.b.nv = a;
						this.b.st = b;
					...
					sc: function() {
						...
						this.b.cw = b.m(a, k.Yb) || b.m(a, k.zc) || "";
					...
					yb: function() {
						var a = document.location.hash.substring(1)
							...
							, f = b.m(a, "jn")
							, g = /^select$/.test(f);
						a && (d.test(a) && e && g) && (this.b.rnd = Math.round(Math.random() * k.Ga),
								...
								p.e(window, "message", function(d) {
									if (b.L(d.origin) === k.nb) {
										...
										if (RegExp(c.id).test(d.sd || "") && f)
											a.b.rnd = Math.round(Math.random() * k.Ga),
												m(k.protocol + "//" + c.js + e + ".js?" + a.b.rnd)
									}
								});
		...
		(function() {
				...
				if ("undefined" !== typeof h.c && (c.med || (!a.Ca || 7 < a.Nb()) && c.cvcc)) {
					var e, r, f, l, n = function(a) {
						...
						for (var d in a)
							if (a.hasOwnProperty(d) && b.call(a, d, a[d]) === x)
								return x
					}, s = function(a, g) {
						var k = {};
						k.n = e;
						...
						if (g) {
							...
							f.test(l) ? (k.sn = "mediate",
								k.snv = l) : b.d(n, "String") && f.test(n) && (k.sn = "wrap",
								k.snv = n);
							k.id = p
						}
						h.c.b.et = 86;
					...
					if (c.med)
						r = "/zoosnet",
							...
							l = {
								click: function() {
									for (var a = [], b = n(document.getElementsByTagName("a")), b = [].concat.apply(b, n(document.getElementsByTagName("area"))), b = [].concat.apply(b, n(document.getElementsByTagName("img"))), d, e, g = 0, k = b.length; g < k; g++)
										d = b[g],
						...
						l = {
							click: function() {
								for (var a = [], b = n(document.getElementsByTagName("a")), b = [].concat.apply(b, n(document.getElementsByTagName("area"))), b = [].concat.apply(b, n(document.getElementsByTagName("img"))), d, e, g, k = 0, l = b.length; k < l; k++)
									d = b[k],
										f !== q ? (e = d.getAttribute("onclick"),
											g = d.getAttribute("href"),
											t ? (d = d.getAttribute("id"),
											(f.test(e) || f.test(g) || t.test(d)) && a.push(b[k])) : (f.test(e) || f.test(g)) && a.push(b[k])) : t !== q && (d = d.getAttribute("id"),
										t.test(d) && a.push(b[k]));
								return a
							}
						}
		...
		(function() {
				...
				if ("undefined" !== typeof h.c && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
					var e = {
						qb: function() {
							for (var b = c.cvcf.length, d, l = 0; l < b; l++)
								(d = a.Ua(decodeURIComponent(c.cvcf[l]))) && g.e(d, "click", e.ta())
						},
						ta: function() {
							return function() {
								h.c.b.et = 86;
		...
		c.oc !== q && "1" === String(c.oc) && (window._hmt = window._hmt || [],
