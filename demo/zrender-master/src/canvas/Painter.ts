...
function createRoot(width: number, height: number) {
    // <div style="position: relative; width: 800px; height: 800px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;"><canvas data-zr-dom-id="zr_0" width="800" height="800" style="position: absolute; left: 0px; top: 0px; width: 800px; height: 800px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas></div>
