...
exports.parseRichText = exports.RichTextContentBlock = exports.parsePlainText = exports.truncateText = void 0;
...
function pushTokens(block, str, style, wrapInfo, styleName) {
    ...
    if (wrapInfo) {
        ...
        if (tokenStyle.width != null && tokenStyle.width !== 'auto') {
            var outerWidth_1 = text_1.parsePercent(tokenStyle.width, wrapInfo.width) + tokenPaddingH;
            if (lines.length > 0) {
