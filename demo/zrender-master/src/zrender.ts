...
/**
 * 字典对象
 * key存储canvas或者svg,value存储Painter画图
 */
...
class ZRender {
    ...
    constructor(id: number, dom: HTMLElement, opts?: ZRenderInitOpt) {
        ...
        if (!painterCtors[rendererType]) {
            ...
            const d = zrUtil.keys(painterCtors);
            console.log(d);
            debugger
    ...
    on<Ctx>(eventName: string, eventHandler: WithThisType<EventCallback<any[]>,
        unknown extends Ctx ? ZRenderType : Ctx>, context?: Ctx): this
