...
exports.PRESERVED_NORMAL_STATE = void 0;
...
var constants_1 = require("./graphic/constants");
...
var Element = (function () {
    ...
    Element.prototype.updateInnerText = function (forceUpdate) {
        ...
        if (textEl && (!textEl.ignore || forceUpdate)) {
            ...
            textEl.__dirty |= constants_1.REDARAW_BIT;
            if (textStyleChanged) {
    ...
    Element.prototype.useState = function (stateName, keepCurrentStates, noAnimation, forceUseHoverLayer) {
        ...
        if (!useHoverLayer && this.__inHover) {
            ...
            this.__dirty &= ~constants_1.REDARAW_BIT;
        }
        return state;
    };
    ...
    Element.prototype.setTextContent = function (textEl) {
        ...
        textEl.innerTransformable = new Transformable_1["default"]();
    ...
    Element.initDefaultProps = (function () {
        ...
        elProto.__dirty = constants_1.REDARAW_BIT;
        var logs = {};
