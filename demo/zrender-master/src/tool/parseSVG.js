...
exports.parseXML = exports.parseSVG = exports.makeViewBoxTransform = void 0;
...
exports.parseXML = parseXML_1.parseXML;
;
var nodeParsers;
...
var INHERITABLE_STYLE_ATTRIBUTES_MAP_KEYS = util_1.keys(INHERITABLE_STYLE_ATTRIBUTES_MAP);
var SELF_STYLE_ATTRIBUTES_MAP = {
    'alignment-baseline': 'textBaseline',
    'stop-color': 'stopColor'
};
var SELF_STYLE_ATTRIBUTES_MAP_KEYS = util_1.keys(SELF_STYLE_ATTRIBUTES_MAP);
var SVGParser = (function () {
    ...
    SVGParser.prototype.parse = function (xml, opt) {
        opt = opt || {};
        var svg = parseXML_1.parseXML(xml);
        if (!svg) {
    ...
    SVGParser.prototype._parseNode = function (xmlNode, parentGroup, named, namedFrom, isInDefs, isInText) {
        ...
        if (nodeName === 'defs' || nodeName === 'switch') {
            ...
            if (!isInDefs) {
                ...
                if (parser_1 && util_1.hasOwn(nodeParsers, nodeName)) {
            ...
            if (parser && util_1.hasOwn(paintServerParsers, nodeName)) {
...
var paintServerParsers = {
    ...
    'radialgradient': function (xmlNode) {
        ...
        var gradient = new RadialGradient_1["default"](cx, cy, r);
        parsePaintServerUnit(xmlNode, gradient);
        parseGradientColorStops(xmlNode, gradient);
        return gradient;
    }
...
function parseAttributes(xmlNode, el, defsUsePending, onlyInlineStyle, isTextGroup) {
    ...
    if (inheritedStyle.lineDash) {
        disp.style.lineDash = util_1.map(splitNumberSequence(inheritedStyle.lineDash), function (str) {
...
function parseInlineStyle(xmlNode, inheritableStyleResult, selfStyleResult) {
    ...
    while ((styleRegResult = styleRegex.exec(style)) != null) {
        ...
        var zrInheritableStlAttr = util_1.hasOwn(INHERITABLE_STYLE_ATTRIBUTES_MAP, svgStlAttr)
            ? INHERITABLE_STYLE_ATTRIBUTES_MAP[svgStlAttr]
            : null;
        if (zrInheritableStlAttr) {
            inheritableStyleResult[zrInheritableStlAttr] = styleRegResult[2];
        }
        var zrSelfStlAttr = util_1.hasOwn(SELF_STYLE_ATTRIBUTES_MAP, svgStlAttr)
