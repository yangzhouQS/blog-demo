...
exports.clonePath = exports.mergePath = exports.extendFromString = exports.createFromString = void 0;
...
function clonePath(sourcePath, opts) {
    ...
    if (opts.bakeTransform) {
        transformPath_1["default"](path.path, sourcePath.getComputedTransform());
    }
    else {
        if (opts.toLocal) {
