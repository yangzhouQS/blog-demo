...
let sql = `update q_produce
           set q_produce.trans_mete = b.trans_mete,
               q_produce.car_amnt   = b.car_amnt,
               q_produce.pie_cnt    = b.pie_cnt,
               q_produce.dat_tim    = b.dat_tim,
               version              = __fn.sequence()
           from q_produce join (values`
