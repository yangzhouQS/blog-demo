...
class QueryInterface {
  ...
  /**
   * 查询数据库版本号Return database version
   *
   * @param {object}    [options]      Query options
  ...
  /**
   * 从数据库中删除表Drop a table from database
   *
  ...
  /**
   * 从数据库中删除所有表Drop all tables from database
   *
   * @param {object} [options] query options
  ...
  /**
   * 查询所有的数据库表Get all tables in current database
   *
   * @param {object}    [options] Query options
  ...
  /**
   * 移除列Remove a column from a table
   *
  ...
  /**
   * 向列添加索引Add an index to a column
   *
  ...
  /**
   * 移除列索引Remove an already existing index from a table
   *
  ...
  /**
   * 向表添加约束Add a constraint to a table
   *
  ...
  /**
   * 将多个记录插入表中Insert multiple records into a table
   *
   * @example
  ...
  /**
   * 更新一个表的多个记录Update multiple records of a table
   *
   * @example
  ...
  /**
   * 从表中删除多个记录 Delete multiple records from a table
   *
