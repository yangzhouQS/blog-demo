(function() {
    ...
    var grid = function() {
        ...
        var states = ["China", "France", "Paris", "USA", "New York", "Albany", "Syracuse", "California", "Alameda", "Orange", "Anaheim", "Laguna", "Irvine", "Ventura", "Anaheim", "Garden Grove", "Monterey", "Fullerton", "Boston", "Worcester", "Lowell", "Pudding Lane", "Canada"];
        for (var i = 0; i < states.length; i++) {
            var state = states[i];
            lookupRecords.push({ id: state, name: state });
        }
