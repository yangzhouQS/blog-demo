 ...
 */
export declare function getCircleRadianPoint(x: number, y: number, radius: number, radian: number): Point;
export declare function checkPointIsInSector(point: Point, { rx, ry, r, startAngle, endAngle, clockWise }: ArcShape): boolean;
/**
 * @description Get the points that make up a regular polygon
 */
export declare function getRegularPolygonPoints({ rx, ry, r, side }: RegPolygonShape, minus?: number): Point[];
/**
 ...
 */
export declare function checkPointIsNearPolyline(point: Point, polyline: Point[], lineWidth: number): boolean;
/**
