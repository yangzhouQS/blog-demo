!(function(t) {
  if ('object' == typeof exports && 'undefined' != typeof module) module.exports = t();
    ...
    var r;
    (r = 'undefined' != typeof window ? window : 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : this), (r.QRCode = t());
  }
})(function() {
  return (function() {
    function t(r, e, n) {
  ...
  })()(
    {
      ...
      2: [
        function(t, r, e) {
          ...
          (e.getRowColCoords = function(t) {
            if (1 === t) return [];
            for (var r = Math.floor(t / 7) + 2, e = n(t), o = 145 === e ? 26 : 2 * Math.ceil((e - 13) / (2 * r - 2)), i = [e - 7], u = 1; u < r - 1; u++) i[u] = i[u - 1] - o;
            return i.push(6), i.reverse();
          }),
            (e.getPositions = function(t) {
              for (var r = [], n = e.getRowColCoords(t), o = n.length, i = 0; i < o; i++)
                for (var u = 0; u < o; u++) (0 === i && 0 === u) || (0 === i && u === o - 1) || (i === o - 1 && 0 === u) || r.push([n[i], n[u]]);
              return r;
            });
        },
        { './utils': 21 },
          ...
          (n.getBitsLength = function(t) {
            ...
            (n.prototype.write = function(t) {
              ...
              for (r = 0; r + 2 <= this.data.length; r += 2) {
                var e = 45 * i.indexOf(this.data[r]);
                (e += i.indexOf(this.data[r + 1])), t.put(e, 11);
              }
              this.data.length % 2 && t.put(i.indexOf(this.data[r]), 6);
            }),
            (r.exports = n);
        },
        { './mode': 14 },
      ...
      5: [
        function(t, r, e) {
          function n(t) {
            ...
            (this.size = t), (this.data = o.alloc(t * t)), (this.reservedBit = o.alloc(t * t));
          }
      ...
      6: [
        function(t, r, e) {
          function n(t) {
            (this.mode = i.BYTE), (this.data = o.from(t));
          }
          var o = t('../utils/buffer'),
            i = t('./mode');
          (n.getBitsLength = function(t) {
      ...
      7: [
        function(t, r, e) {
          ...
          (e.getBlocksCount = function(t, r) {
            ...
            (e.getTotalCodewordsCount = function(t, r) {
              switch (r) {
                case n.L:
                  return i[4 * (t - 1) + 0];
                case n.M:
      ...
      10: [
        function(t, r, e) {
          ...
          e.getEncodedBits = function(t, r) {
            for (var e = (t.bit << 3) | r, i = e << 10; n.getBCHDigit(i) - o >= 0; ) i ^= 1335 << (n.getBCHDigit(i) - o);
            return 21522 ^ ((e << 10) | i);
          };
        },
        { './utils': 21 },
      ...
      11: [
        function(t, r, e) {
          var n = t('../utils/buffer'),
            ...
            i = n.alloc(256);
          !(function() {
            for (var t = 1, r = 0; r < 255; r++) (o[r] = t), (i[t] = r), 256 & (t <<= 1) && (t ^= 285);
        ...
        function(t, r, e) {
          ...
          (e.isValid = function(t) {
            ...
            (e.getPenaltyN1 = function(t) {
              for (var r = t.size, e = 0, n = 0, i = 0, u = null, a = null, f = 0; f < r; f++) {
                (n = i = 0), (u = a = null);
                for (var s = 0; s < r; s++) {
                  var h = t.get(f, s);
                  h === u ? n++ : (n >= 5 && (e += o.N1 + (n - 5)), (u = h), (n = 1)), (h = t.get(s, f)), h === a ? i++ : (i >= 5 && (e += o.N1 + (i - 5)), (a = h), (i = 1));
                }
                n >= 5 && (e += o.N1 + (n - 5)), i >= 5 && (e += o.N1 + (i - 5));
              }
              return e;
            }),
            (e.getPenaltyN2 = function(t) {
              for (var r = t.size, e = 0, n = 0; n < r - 1; n++)
                for (var i = 0; i < r - 1; i++) {
                  var u = t.get(n, i) + t.get(n, i + 1) + t.get(n + 1, i) + t.get(n + 1, i + 1);
                  (4 !== u && 0 !== u) || e++;
                }
              return e * o.N2;
            }),
            (e.getPenaltyN3 = function(t) {
              for (var r = t.size, e = 0, n = 0, i = 0, u = 0; u < r; u++) {
                n = i = 0;
                for (var a = 0; a < r; a++)
                  (n = ((n << 1) & 2047) | t.get(u, a)),
                    a >= 10 && (1488 === n || 93 === n) && e++,
                    (i = ((i << 1) & 2047) | t.get(a, u)),
                    a >= 10 && (1488 === i || 93 === i) && e++;
              }
              return e * o.N3;
            }),
            (e.getPenaltyN4 = function(t) {
              ...
              return Math.abs(Math.ceil((100 * r) / e / 5) - 10) * o.N4;
            }),
            (e.applyMask = function(t, r) {
              for (var e = r.size, o = 0; o < e; o++) for (var i = 0; i < e; i++) r.isReserved(i, o) || r.xor(i, o, n(t, i, o));
            }),
            (e.getBestMask = function(t, r) {
              for (var n = Object.keys(e.Patterns).length, o = 0, i = 1 / 0, u = 0; u < n; u++) {
                r(u), e.applyMask(u, t);
      ...
      16: [
        function(t, r, e) {
          var n = t('../utils/buffer'),
            o = t('./galois-field');
          (e.mul = function(t, r) {
            for (var e = n.alloc(t.length + r.length - 1), i = 0; i < t.length; i++) for (var u = 0; u < r.length; u++) e[i + u] ^= o.mul(t[i], r[u]);
            return e;
          }),
            (e.mod = function(t, r) {
              for (var e = n.from(t); e.length - r.length >= 0; ) {
                for (var i = e[0], u = 0; u < r.length; u++) e[u] ^= o.mul(r[u], i);
            ...
            (e.generateECPolynomial = function(t) {
              for (var r = n.from([1]), i = 0; i < t; i++) r = e.mul(r, [1, o.exp(i)]);
              return r;
            });
        },
      ...
      17: [
        function(t, r, e) {
          function n(t, r) {
            for (var e = t.size, n = w.getPositions(r), o = 0; o < n.length; o++)
              for (var i = n[o][0], u = n[o][1], a = -1; a <= 7; a++)
                if (!(i + a <= -1 || e <= i + a))
                  for (var f = -1; f <= 7; f++)
                    u + f <= -1 ||
                      e <= u + f ||
                      ((a >= 0 && a <= 6 && (0 === f || 6 === f)) || (f >= 0 && f <= 6 && (0 === a || 6 === a)) || (a >= 2 && a <= 4 && f >= 2 && f <= 4)
                        ? t.set(i + a, u + f, !0, !0)
                        : t.set(i + a, u + f, !1, !0));
          }
          function o(t) {
          ...
          function i(t, r) {
            for (var e = v.getPositions(r), n = 0; n < e.length; n++)
              for (var o = e[n][0], i = e[n][1], u = -2; u <= 2; u++)
                for (var a = -2; a <= 2; a++) -2 === u || 2 === u || -2 === a || 2 === a || (0 === u && 0 === a) ? t.set(o + u, i + a, !0, !0) : t.set(o + u, i + a, !1, !0);
          }
          function u(t, r) {
            for (var e, n, o, i = t.size, u = A.getEncodedBits(r), a = 0; a < 18; a++)
              (e = Math.floor(a / 3)), (n = (a % 3) + i - 8 - 3), (o = 1 == ((u >> a) & 1)), t.set(e, n, o, !0), t.set(n, e, o, !0);
          }
          function a(t, r, e) {
            var n,
              o,
              i = t.size,
              u = B.getEncodedBits(r, e);
            for (n = 0; n < 15; n++)
              (o = 1 == ((u >> n) & 1)),
          ...
          function f(t, r) {
            for (var e = t.size, n = -1, o = e - 1, i = 7, u = 0, a = e - 1; a > 0; a -= 2)
              for (6 === a && a--; ; ) {
                for (var f = 0; f < 2; f++)
                  if (!t.isReserved(o, a - f)) {
                    var s = !1;
                    u < r.length && (s = 1 == ((r[u] >>> i) & 1)), t.set(o, a - f, s), i--, -1 === i && (u++, (i = 7));
                  }
                if ((o += n) < 0 || e <= o) {
                  (o -= n), (n = -n);
                  break;
          ...
          function s(t, r, e) {
            ...
            e.forEach(function(r) {
              n.put(r.mode.bit, 4), n.put(r.getLength(), T.getCharCountIndicator(r.mode, t)), r.write(n);
            });
            var o = g.getSymbolTotalCodewords(t),
              i = b.getTotalCodewordsCount(t, r),
              u = 8 * (o - i);
            for (n.getLengthInBits() + 4 <= u && n.put(0, 4); n.getLengthInBits() % 8 != 0; ) n.putBit(0);
            for (var a = (u - n.getLengthInBits()) / 8, f = 0; f < a; f++) n.put(f % 2 ? 17 : 236, 8);
            return h(n, t, r);
          }
          function h(t, r, e) {
            for (
              var n = g.getSymbolTotalCodewords(r),
                o = b.getTotalCodewordsCount(r, e),
                i = n - o,
                u = b.getBlocksCount(r, e),
                a = n % u,
                f = u - a,
                s = Math.floor(n / u),
                h = Math.floor(i / u),
              ...
              var T = B < f ? h : c;
              (v[B] = A.slice(y, y + T)), (w[B] = d.encode(v[B])), (y += T), (m = Math.max(m, T));
            }
            var R,
              C,
              P = l.alloc(n),
              I = 0;
            for (R = 0; R < m; R++) for (C = 0; C < u; C++) R < v[C].length && (P[I++] = v[C][R]);
            for (R = 0; R < p; R++) for (C = 0; C < u; C++) P[I++] = w[C][R];
            return P;
          }
          function c(t, r, e, h) {
            var c;
            if (C(t)) c = R.fromArray(t);
            else {
              if ('string' != typeof t) throw new Error('Invalid data');
              var l = r;
              if (!l) {
                var p = R.rawSplit(t);
                l = A.getBestVersionForData(p, e);
              }
              c = R.fromString(t, l || 40);
            }
            var d = A.getBestVersionForData(c, e);
            if (!d) throw new Error('The amount of data is too big to be stored in a QR Code');
            if (r) {
              if (r < d) throw new Error('\nThe chosen QR Code version cannot contain this amount of data.\nMinimum version required to store current data is: ' + d + '.\n');
            } else r = d;
            var v = s(r, e, c),
              w = g.getSymbolSize(r),
              b = new y(w);
            return (
              ...
              r >= 7 && u(b, r),
              f(b, v),
              isNaN(h) && (h = m.getBestMask(b, a.bind(null, b, e))),
              m.applyMask(h, b),
              a(b, e, h),
              { modules: b, version: r, errorCorrectionLevel: e, maskPattern: h, segments: c }
            );
          }
          var l = t('../utils/buffer'),
            g = t('./utils'),
            p = t('./error-correction-level'),
            d = t('./bit-buffer'),
            y = t('./bit-matrix'),
            v = t('./alignment-pattern'),
            w = t('./finder-pattern'),
            m = t('./mask-pattern'),
            b = t('./error-correction-code'),
            E = t('./reed-solomon-encoder'),
            A = t('./version'),
            B = t('./format-info'),
            T = t('./mode'),
            R = t('./segments'),
          ...
          e.create = function(t, r) {
            ...
            var e,
              ...
              o = p.M;
            return (
              void 0 !== r && ((o = p.from(r.errorCorrectionLevel, p.M)), (e = A.from(r.version)), (n = m.from(r.maskPattern)), r.toSJISFunc && g.setToSJISFunction(r.toSJISFunc)),
              c(t, e, o, n)
            );
          };
        },
          ...
          (n.prototype.initialize = function(t) {
            ...
            (n.prototype.encode = function(t) {
              ...
              var r = o.alloc(this.degree),
                e = u.concat([t, r], t.length + this.degree),
                n = i.mod(e, this.genPoly),
                a = this.degree - n.length;
              if (a > 0) {
                var f = o.alloc(this.degree);
                return n.copy(f, a), f;
              }
              return n;
            }),
      ...
      20: [
        function(t, r, e) {
          ...
          function o(t, r, e) {
            for (var n, o = []; null !== (n = t.exec(e)); ) o.push({ data: n[0], index: n.index, mode: r, length: n[0].length });
            return o;
          }
          function i(t) {
            var r,
              e,
              n = o(y.NUMERIC, c.NUMERIC, t),
              i = o(y.ALPHANUMERIC, c.ALPHANUMERIC, t);
            return (
              v.isKanjiModeEnabled() ? ((r = o(y.BYTE, c.BYTE, t)), (e = o(y.KANJI, c.KANJI, t))) : ((r = o(y.BYTE_KANJI, c.BYTE, t)), (e = [])),
              n
                .concat(i, r, e)
                .sort(function(t, r) {
          ...
          function f(t) {
            for (var r = [], e = 0; e < t.length; e++) {
              ...
              switch (o.mode) {
                case c.NUMERIC:
                  r.push([o, { data: o.data, mode: c.ALPHANUMERIC, length: o.length }, { data: o.data, mode: c.BYTE, length: o.length }]);
                  break;
                case c.ALPHANUMERIC:
                  r.push([o, { data: o.data, mode: c.BYTE, length: o.length }]);
                  break;
                case c.KANJI:
                  r.push([o, { data: o.data, mode: c.BYTE, length: n(o.data) }]);
                  break;
                case c.BYTE:
                  r.push([{ data: o.data, mode: c.BYTE, length: n(o.data) }]);
              }
            }
            return r;
          }
          function s(t, r) {
            for (var e = {}, n = { start: {} }, o = ['start'], i = 0; i < t.length; i++) {
              for (var a = t[i], f = [], s = 0; s < a.length; s++) {
                var h = a[s],
                  l = '' + i + s;
                f.push(l), (e[l] = { node: h, lastCount: 0 }), (n[l] = {});
                for (var g = 0; g < o.length; g++) {
                  var p = o[g];
                  e[p] && e[p].node.mode === h.mode
                    ? ((n[p][l] = u(e[p].lastCount + h.length, h.mode) - u(e[p].lastCount, h.mode)), (e[p].lastCount += h.length))
                    : (e[p] && (e[p].lastCount = h.length), (n[p][l] = u(h.length, h.mode) + 4 + c.getCharCountIndicator(h.mode, r)));
                }
              }
              o = f;
            }
            for (g = 0; g < o.length; g++) n[o[g]].end = 0;
            return { map: n, table: e };
          }
          function h(t, r) {
            var e,
              n = c.getBestModeForData(t);
            if ((e = c.from(r, n)) !== c.BYTE && e.bit < n.bit)
              throw new Error('"' + t + '" cannot be encoded with mode ' + c.toString(e) + '.\n Suggested mode is: ' + c.toString(n));
            switch ((e !== c.KANJI || v.isKanjiModeEnabled() || (e = c.BYTE), e)) {
              case c.NUMERIC:
                return new l(t);
              case c.ALPHANUMERIC:
                return new g(t);
          ...
          (e.fromArray = function(t) {
            return t.reduce(function(t, r) {
              return 'string' == typeof r ? t.push(h(r, null)) : r.data && t.push(h(r.data, r.mode)), t;
            }, []);
          }),
            (e.fromString = function(t, r) {
              for (var n = i(t, v.isKanjiModeEnabled()), o = f(n), u = s(o, r), h = w.find_path(u.map, 'start', 'end'), c = [], l = 1; l < h.length - 1; l++)
                c.push(u.table[h[l]].node);
              return e.fromArray(a(c));
            }),
            (e.rawSplit = function(t) {
              return e.fromArray(i(t, v.isKanjiModeEnabled()));
            });
        },
        { './alphanumeric-data': 3, './byte-data': 6, './kanji-data': 12, './mode': 14, './numeric-data': 15, './regex': 19, './utils': 21, dijkstrajs: 31 },
      ],
      21: [
        function(t, r, e) {
          var n,
      ...
      23: [
        function(t, r, e) {
          ...
          function o(t, r) {
            return h.getCharCountIndicator(t, r) + 4;
          }
          function i(t, r) {
            var e = 0;
            return (
          ...
          function u(t, r) {
            for (var n = 1; n <= 40; n++) {
              if (i(t, n) <= e.getCapacity(n, r, h.MIXED)) return n;
            }
          }
          var a = t('./utils'),
            f = t('./error-correction-code'),
            s = t('./error-correction-level'),
            h = t('./mode'),
            c = t('./version-check'),
            l = t('isarray'),
            g = a.getBCHDigit(7973);
          (e.from = function(t, r) {
            return c.isValid(t) ? parseInt(t, 10) : r;
          }),
            (e.getCapacity = function(t, r, e) {
              if (!c.isValid(t)) throw new Error('Invalid QR Code version');
              void 0 === e && (e = h.BYTE);
              var n = a.getSymbolTotalCodewords(t),
                i = f.getTotalCodewordsCount(t, r),
                u = 8 * (n - i);
              if (e === h.MIXED) return u;
              var s = u - o(e, t);
              switch (e) {
                case h.NUMERIC:
            ...
            (e.getBestVersionForData = function(t, r) {
              var e,
                o = s.from(r, s.M);
              if (l(t)) {
                if (t.length > 1) return u(t, o);
                if (0 === t.length) return 1;
                e = t[0];
              } else e = t;
              return n(e.mode, e.getLength(), o);
            }),
            (e.getEncodedBits = function(t) {
              if (!c.isValid(t) || t < 7) throw new Error('Invalid QR Code version');
              for (var r = t << 12; a.getBCHDigit(r) - g >= 0; ) r ^= 7973 << (a.getBCHDigit(r) - g);
              return (t << 12) | r;
            });
        },
        { './error-correction-code': 7, './error-correction-level': 8, './mode': 14, './utils': 21, './version-check': 22, isarray: 33 },
      ],
      24: [
        function(t, r, e) {
          function n(t, r, e, n, u) {
            ...
            2 === f ? ((u = e), (e = r), (r = n = void 0)) : 3 === f && (r.getContext && void 0 === u ? ((u = n), (n = void 0)) : ((u = n), (n = e), (e = r), (r = void 0)));
            try {
              var h = i.create(e, n);
              u(null, t(h, r, n));
            } catch (t) {
          ...
          (e.create = i.create),
            (e.toCanvas = n.bind(null, u.render)),
            (e.toDataURL = n.bind(null, u.renderToDataURL)),
            (e.toString = n.bind(null, function(t, r, e) {
              return a.render(t, e);
            }));
        },
      ...
      25: [
        function(t, r, e) {
          ...
          (e.render = function(t, r, e) {
            var u = e,
              a = r;
            void 0 !== u || (r && r.getContext) || ((u = r), (r = void 0)), r || (a = o()), (u = i.getOptions(u));
            var f = i.getImageWidth(t.modules.size, u),
              s = a.getContext('2d'),
              h = s.createImageData(f, f);
            return i.qrToImageData(h.data, t, u), n(s, a, f), s.putImageData(h, 0, 0), a;
          }),
      ...
      26: [
        function(t, r, e) {
          ...
          function i(t, r, e) {
            for (var n = '', i = 0, u = !1, a = 0, f = 0; f < t.length; f++) {
              var s = Math.floor(f % r),
                h = Math.floor(f / r);
              s || u || (u = !0),
                t[f]
                  ? (a++,
                    (f > 0 && s > 0 && t[f - 1]) || ((n += u ? o('M', s + e, 0.5 + h + e) : o('m', i, 0)), (i = 0), (u = !1)),
                    (s + 1 < r && t[f + 1]) || ((n += o('h', a)), (a = 0)))
                  : i++;
            }
            return n;
          }
          var u = t('./utils');
          e.render = function(t, r, e) {
            var o = u.getOptions(r),
              a = t.modules.size,
              f = t.modules.data,
              s = a + 2 * o.margin,
              h = o.color.light.a ? '<path ' + n(o.color.light, 'fill') + ' d="M0 0h' + s + 'v' + s + 'H0z"/>' : '',
              c = '<path ' + n(o.color.dark, 'stroke') + ' d="' + i(f, a, o.margin) + '"/>',
              l = 'viewBox="0 0 ' + s + ' ' + s + '"',
      ...
      27: [
        function(t, r, e) {
          function n(t) {
            ...
            return { r: (e >> 24) & 255, g: (e >> 16) & 255, b: (e >> 8) & 255, a: 255 & e, hex: '#' + r.slice(0, 6).join('') };
          }
            ...
            (e.qrToImageData = function(t, r, n) {
              for (
                ...
                for (var c = 0; c < a; c++) {
                  var l = 4 * (h * a + c),
                    g = n.color.light;
                  if (h >= f && c >= f && h < a - f && c < a - f) {
                    var p = Math.floor((h - f) / u),
                      d = Math.floor((c - f) / u);
                    g = s[i[p * o + d] ? 1 : 0];
                  }
      ...
      28: [
        function(t, r, e) {
          'use strict';
          function n(t, r, e) {
            return n.TYPED_ARRAY_SUPPORT || this instanceof n ? ('number' == typeof t ? a(this, t) : y(this, t, r, e)) : new n(t, r, e);
          }
          function o(t) {
            if (t >= w) throw new RangeError('Attempt to allocate Buffer larger than maximum size: 0x' + w.toString(16) + ' bytes');
            return 0 | t;
          }
          function i(t) {
            return t !== t;
          ...
          function u(t, r) {
            var e;
            return n.TYPED_ARRAY_SUPPORT ? ((e = new Uint8Array(r)), (e.__proto__ = n.prototype)) : ((e = t), null === e && (e = new n(r)), (e.length = r)), e;
          }
          function a(t, r) {
            var e = u(t, r < 0 ? 0 : 0 | o(r));
            if (!n.TYPED_ARRAY_SUPPORT) for (var i = 0; i < r; ++i) e[i] = 0;
            return e;
          }
          function f(t, r) {
            var e = 0 | g(r),
          ...
          function s(t, r) {
            for (var e = r.length < 0 ? 0 : 0 | o(r.length), n = u(t, e), i = 0; i < e; i += 1) n[i] = 255 & r[i];
            return n;
          }
          function h(t, r, e, o) {
            if (e < 0 || r.byteLength < e) throw new RangeError("'offset' is out of bounds");
            if (r.byteLength < e + (o || 0)) throw new RangeError("'length' is out of bounds");
            var i;
            return (
              (i = void 0 === e && void 0 === o ? new Uint8Array(r) : void 0 === o ? new Uint8Array(r, e) : new Uint8Array(r, e, o)),
              n.TYPED_ARRAY_SUPPORT ? (i.__proto__ = n.prototype) : (i = s(t, i)),
              i
            );
          }
          function c(t, r) {
            if (n.isBuffer(r)) {
              var e = 0 | o(r.length),
                a = u(t, e);
              return 0 === a.length ? a : (r.copy(a, 0, 0, e), a);
            }
            if (r) {
              if (('undefined' != typeof ArrayBuffer && r.buffer instanceof ArrayBuffer) || 'length' in r) return 'number' != typeof r.length || i(r.length) ? u(t, 0) : s(t, r);
              if ('Buffer' === r.type && Array.isArray(r.data)) return s(t, r.data);
            }
          ...
          function g(t) {
            return n.isBuffer(t)
              ...
              ? t.byteLength
              : ('string' != typeof t && (t = '' + t), 0 === t.length ? 0 : l(t).length);
          }
          function p(t, r, e, n) {
          ...
          function d(t, r, e, n) {
            return p(l(r, t.length - e), t, e, n);
          }
          function y(t, r, e, n) {
            if ('number' == typeof r) throw new TypeError('"value" argument must not be a number');
            return 'undefined' != typeof ArrayBuffer && r instanceof ArrayBuffer ? h(t, r, e, n) : 'string' == typeof r ? f(t, r, e) : c(t, r);
          }
          var v = t('isarray');
          ...
          var w = n.TYPED_ARRAY_SUPPORT ? 2147483647 : 1073741823;
          n.TYPED_ARRAY_SUPPORT &&
            ...
            'undefined' != typeof Symbol &&
              Symbol.species &&
              n[Symbol.species] === n &&
              Object.defineProperty(n, Symbol.species, { value: null, configurable: !0, enumerable: !1, writable: !1 })),
            (n.prototype.write = function(t, r, e) {
              void 0 === r
                ? ((e = this.length), (r = 0))
                : void 0 === e && 'string' == typeof r
                ? ((e = this.length), (r = 0))
                : isFinite(r) && ((r |= 0), isFinite(e) ? (e |= 0) : (e = void 0));
              var n = this.length - r;
            ...
            (n.prototype.slice = function(t, r) {
              ...
              var o;
              if (n.TYPED_ARRAY_SUPPORT) (o = this.subarray(t, r)), (o.__proto__ = n.prototype);
              else {
                var i = r - t;
                o = new n(i, void 0);
                for (var u = 0; u < i; ++u) o[u] = this[u + t];
              }
              return o;
            }),
            (n.prototype.copy = function(t, r, e, o) {
              if ((e || (e = 0), o || 0 === o || (o = this.length), r >= t.length && (r = t.length), r || (r = 0), o > 0 && o < e && (o = e), o === e)) return 0;
              if (0 === t.length || 0 === this.length) return 0;
              if (r < 0) throw new RangeError('targetStart out of bounds');
              if (e < 0 || e >= this.length) throw new RangeError('sourceStart out of bounds');
              if (o < 0) throw new RangeError('sourceEnd out of bounds');
              o > this.length && (o = this.length), t.length - r < o - e && (o = t.length - r + e);
              var i,
                u = o - e;
              if (this === t && e < r && r < o) for (i = u - 1; i >= 0; --i) t[i + r] = this[i + e];
              else if (u < 1e3 || !n.TYPED_ARRAY_SUPPORT) for (i = 0; i < u; ++i) t[i + r] = this[i + e];
            ...
            (n.prototype.fill = function(t, r, e) {
              ...
              var i;
              if ('number' == typeof t) for (i = r; i < e; ++i) this[i] = t;
              else {
                var u = n.isBuffer(t) ? t : new n(t),
                  a = u.length;
            ...
            (n.concat = function(t, r) {
              ...
              for (e = 0; e < t.length; ++e) {
                var f = t[e];
                if (!n.isBuffer(f)) throw new TypeError('"list" argument must be an Array of Buffers');
                f.copy(o, i), (i += f.length);
              }
              return o;
            }),
            (n.byteLength = g),
            ...
            (r.exports.alloc = function(t) {
              var r = new n(t);
              return r.fill(0), r;
            }),
            (r.exports.from = function(t) {
              return new n(t);
            });
        },
        { isarray: 33 },
        ...
        function(t, r, e) {
          ...
          function u(t) {
            var r,
              ...
              h = a > 0 ? u - 4 : u;
            for (e = 0; e < h; e += 4)
              (r = (c[t.charCodeAt(e)] << 18) | (c[t.charCodeAt(e + 1)] << 12) | (c[t.charCodeAt(e + 2)] << 6) | c[t.charCodeAt(e + 3)]),
                (f[s++] = (r >> 16) & 255),
                (f[s++] = (r >> 8) & 255),
                (f[s++] = 255 & r);
            return (
              2 === a && ((r = (c[t.charCodeAt(e)] << 2) | (c[t.charCodeAt(e + 1)] >> 4)), (f[s++] = 255 & r)),
              1 === a && ((r = (c[t.charCodeAt(e)] << 10) | (c[t.charCodeAt(e + 1)] << 4) | (c[t.charCodeAt(e + 2)] >> 2)), (f[s++] = (r >> 8) & 255), (f[s++] = 255 & r)),
              f
            );
          }
          function a(t) {
          ...
          function f(t, r, e) {
            for (var n, o = [], i = r; i < e; i += 3) (n = ((t[i] << 16) & 16711680) + ((t[i + 1] << 8) & 65280) + (255 & t[i + 2])), o.push(a(n));
            return o.join('');
          }
          function s(t) {
            for (var r, e = t.length, n = e % 3, o = [], i = 0, u = e - n; i < u; i += 16383) o.push(f(t, i, i + 16383 > u ? u : i + 16383));
            return (
              1 === n
                ? ((r = t[e - 1]), o.push(h[r >> 2] + h[(r << 4) & 63] + '=='))
                : 2 === n && ((r = (t[e - 2] << 8) + t[e - 1]), o.push(h[r >> 10] + h[(r >> 4) & 63] + h[(r << 2) & 63] + '=')),
              o.join('')
            );
          }
          (e.byteLength = o), (e.toByteArray = u), (e.fromByteArray = s);
          for (
            var h = [],
              c = [],
      ...
      30: [
        function(t, r, e) {
          'use strict';
          function n(t) {
            if (t > $) throw new RangeError('The value "' + t + '" is invalid for option "size"');
          ...
          function i(t, r, e) {
            ...
            if (J(t, ArrayBuffer) || (t && J(t.buffer, ArrayBuffer))) return c(t, r, e);
          ...
          function a(t, r, e) {
            return u(t), t <= 0 ? n(t) : void 0 !== r ? ('string' == typeof e ? n(t).fill(r, e) : n(t).fill(r)) : n(t);
          }
          function f(t) {
            return u(t), n(t < 0 ? 0 : 0 | g(t));
          }
          function s(t, r) {
            ...
            var e = 0 | d(t, r),
              i = n(e),
              u = i.write(t, r);
            return u !== e && (i = i.slice(0, u)), i;
          }
          function h(t) {
            for (var r = t.length < 0 ? 0 : 0 | g(t.length), e = n(r), o = 0; o < r; o += 1) e[o] = 255 & t[o];
            return e;
          }
          function c(t, r, e) {
            ...
            var n;
            return (n = void 0 === r && void 0 === e ? new Uint8Array(t) : void 0 === e ? new Uint8Array(t, r) : new Uint8Array(t, r, e)), Object.setPrototypeOf(n, o.prototype), n;
          }
          function l(t) {
            if (o.isBuffer(t)) {
              var r = 0 | g(t.length),
            ...
            return void 0 !== t.length ? ('number' != typeof t.length || K(t.length) ? n(0) : h(t)) : 'Buffer' === t.type && Array.isArray(t.data) ? h(t.data) : void 0;
          }
          function g(t) {
          ...
          function m(t, r, e, n, o) {
            ...
            if (o) {
              var h = -1;
              for (s = e; s < a; s++)
                if (i(t, s) === i(r, -1 === h ? 0 : s - h)) {
                  if ((-1 === h && (h = s), s - h + 1 === f)) return h * u;
                } else -1 !== h && (s -= s - h), (h = -1);
            } else
              for (e + f > a && (e = a - f), s = e; s >= 0; s--) {
              ...
              if (o + a <= e) {
                ...
                switch (a) {
                  case 1:
                    ...
                    break;
                  case 2:
                    (f = t[o + 1]), 128 == (192 & f) && (c = ((31 & i) << 6) | (63 & f)) > 127 && (u = c);
                    break;
                  case 3:
                    (f = t[o + 1]),
                      (s = t[o + 2]),
                      128 == (192 & f) && 128 == (192 & s) && (c = ((15 & i) << 12) | ((63 & f) << 6) | (63 & s)) > 2047 && (c < 55296 || c > 57343) && (u = c);
                    break;
                  case 4:
                    (f = t[o + 1]),
                      (s = t[o + 2]),
                      ...
                      128 == (192 & f) &&
                        128 == (192 & s) &&
                        128 == (192 & h) &&
                        (c = ((15 & i) << 18) | ((63 & f) << 12) | ((63 & s) << 6) | (63 & h)) > 65535 &&
                        c < 1114112 &&
                        (u = c);
                }
              }
          ...
          function I(t) {
            ...
            for (var e = '', n = 0; n < r; ) e += String.fromCharCode.apply(String, t.slice(n, (n += X)));
            return e;
          }
          function M(t, r, e) {
            var n = '';
          ...
          function k(t, r, e, n, o) {
            return (r = +r), (e >>>= 0), o || _(t, r, e, 4, 3.4028234663852886e38, -3.4028234663852886e38), V.write(t, r, e, n, 23, 4), e + 4;
          }
          function O(t, r, e, n, o) {
            return (r = +r), (e >>>= 0), o || _(t, r, e, 8, 1.7976931348623157e308, -1.7976931348623157e308), V.write(t, r, e, n, 52, 8), e + 8;
          }
          function Y(t) {
          ...
          (e.Buffer = o), (e.SlowBuffer = p), (e.INSPECT_MAX_BYTES = 50);
          var $ = 2147483647;
          (e.kMaxLength = $),
            ...
            (o.compare = function(t, r) {
              if ((J(t, Uint8Array) && (t = o.from(t, t.offset, t.byteLength)), J(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), !o.isBuffer(t) || !o.isBuffer(r)))
                throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
              if (t === r) return 0;
              for (var e = t.length, n = r.length, i = 0, u = Math.min(e, n); i < u; ++i)
                if (t[i] !== r[i]) {
                  (e = t[i]), (n = r[i]);
                  break;
                }
            ...
            (o.concat = function(t, r) {
              ...
              for (e = 0; e < t.length; ++e) {
                var u = t[e];
                if ((J(u, Uint8Array) && (u = o.from(u)), !o.isBuffer(u))) throw new TypeError('"list" argument must be an Array of Buffers');
            ...
            (o.prototype.swap64 = function() {
              ...
              for (var r = 0; r < t; r += 8) v(this, r, r + 7), v(this, r + 1, r + 6), v(this, r + 2, r + 5), v(this, r + 3, r + 4);
              return this;
            }),
            ...
            Q && (o.prototype[Q] = o.prototype.inspect),
            (o.prototype.compare = function(t, r, e, n, i) {
              if ((J(t, Uint8Array) && (t = o.from(t, t.offset, t.byteLength)), !o.isBuffer(t)))
          ...
          (o.prototype.slice = function(t, r) {
            ...
            (o.prototype.readFloatLE = function(t, r) {
              return (t >>>= 0), r || L(t, 4, this.length), V.read(this, t, !0, 23, 4);
            }),
            (o.prototype.readFloatBE = function(t, r) {
              return (t >>>= 0), r || L(t, 4, this.length), V.read(this, t, !1, 23, 4);
            }),
            (o.prototype.readDoubleLE = function(t, r) {
              return (t >>>= 0), r || L(t, 8, this.length), V.read(this, t, !0, 52, 8);
            }),
            (o.prototype.readDoubleBE = function(t, r) {
              return (t >>>= 0), r || L(t, 8, this.length), V.read(this, t, !1, 52, 8);
            }),
            (o.prototype.writeUIntLE = function(t, r, e, n) {
              if (((t = +t), (r >>>= 0), (e >>>= 0), !n)) {
                x(this, t, r, e, Math.pow(2, 8 * e) - 1, 0);
              }
              var o = 1,
                i = 0;
            ...
            (o.prototype.writeUInt8 = function(t, r, e) {
              return (t = +t), (r >>>= 0), e || x(this, t, r, 1, 255, 0), (this[r] = 255 & t), r + 1;
            }),
            (o.prototype.writeUInt16LE = function(t, r, e) {
              return (t = +t), (r >>>= 0), e || x(this, t, r, 2, 65535, 0), (this[r] = 255 & t), (this[r + 1] = t >>> 8), r + 2;
            }),
            (o.prototype.writeUInt16BE = function(t, r, e) {
              return (t = +t), (r >>>= 0), e || x(this, t, r, 2, 65535, 0), (this[r] = t >>> 8), (this[r + 1] = 255 & t), r + 2;
            }),
            (o.prototype.writeUInt32LE = function(t, r, e) {
              return (
                (t = +t), (r >>>= 0), e || x(this, t, r, 4, 4294967295, 0), (this[r + 3] = t >>> 24), (this[r + 2] = t >>> 16), (this[r + 1] = t >>> 8), (this[r] = 255 & t), r + 4
              );
            }),
            (o.prototype.writeUInt32BE = function(t, r, e) {
              return (
                (t = +t), (r >>>= 0), e || x(this, t, r, 4, 4294967295, 0), (this[r] = t >>> 24), (this[r + 1] = t >>> 16), (this[r + 2] = t >>> 8), (this[r + 3] = 255 & t), r + 4
              );
            }),
            ...
            (o.prototype.writeInt8 = function(t, r, e) {
              return (t = +t), (r >>>= 0), e || x(this, t, r, 1, 127, -128), t < 0 && (t = 255 + t + 1), (this[r] = 255 & t), r + 1;
            }),
            (o.prototype.writeInt16LE = function(t, r, e) {
              return (t = +t), (r >>>= 0), e || x(this, t, r, 2, 32767, -32768), (this[r] = 255 & t), (this[r + 1] = t >>> 8), r + 2;
            }),
            (o.prototype.writeInt16BE = function(t, r, e) {
              return (t = +t), (r >>>= 0), e || x(this, t, r, 2, 32767, -32768), (this[r] = t >>> 8), (this[r + 1] = 255 & t), r + 2;
            }),
            (o.prototype.writeInt32LE = function(t, r, e) {
              return (
                (t = +t),
                (r >>>= 0),
                e || x(this, t, r, 4, 2147483647, -2147483648),
                (this[r] = 255 & t),
                (this[r + 1] = t >>> 8),
                (this[r + 2] = t >>> 16),
                (this[r + 3] = t >>> 24),
            ...
            (o.prototype.copy = function(t, r, e, n) {
              ...
              else if (this === t && e < r && r < n) for (var u = i - 1; u >= 0; --u) t[u + r] = this[u + e];
        ...
        function(t, r, e) {
          ...
          var n = {
            single_source_shortest_paths: function(t, r, e) {
              ...
              u.push(r, 0);
              for (var a, f, s, h, c, l, g, p; !u.empty(); ) {
                (a = u.pop()), (f = a.value), (h = a.cost), (c = t[f] || {});
                for (s in c) c.hasOwnProperty(s) && ((l = c[s]), (g = h + l), (p = i[s]), (void 0 === i[s] || p > g) && ((i[s] = g), u.push(s, g), (o[s] = f)));
              }
              if (void 0 !== e && void 0 === i[e]) {
                var d = ['Could not find a path from ', r, ' to ', e, '.'].join('');
                throw new Error(d);
              }
              return o;
            },
        ...
        function(t, r, e) {
          (e.read = function(t, r, e, n, o) {
            var i,
              ...
              l = e ? -1 : 1,
              g = t[r + c];
            for (c += l, i = g & ((1 << -h) - 1), g >>= -h, h += a; h > 0; i = 256 * i + t[r + c], c += l, h -= 8);
            for (u = i & ((1 << -h) - 1), i >>= -h, h += n; h > 0; u = 256 * u + t[r + c], c += l, h -= 8);
            if (0 === i) i = 1 - s;
            else {
              if (i === f) return u ? NaN : (1 / 0) * (g ? -1 : 1);
              (u += Math.pow(2, n)), (i -= s);
            }
                ...
                r = Math.abs(r),
                  isNaN(r) || r === 1 / 0
                    ...
                    : ((u = Math.floor(Math.log(r) / Math.LN2)),
                      ...
                      r * f >= 2 && (u++, (f /= 2)),
                      u + c >= h ? ((a = 0), (u = h)) : u + c >= 1 ? ((a = (r * f - 1) * Math.pow(2, o)), (u += c)) : ((a = r * Math.pow(2, c - 1) * Math.pow(2, o)), (u = 0)));
                o >= 8;
                t[e + g] = 255 & a, g += p, a /= 256, o -= 8
              );
              for (u = (u << o) | a, s += o; s > 0; t[e + g] = 255 & u, g += p, u /= 256, s -= 8);
              t[e + g - p] |= 128 * d;
            });
        },
        {},
