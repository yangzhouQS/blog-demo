    ...
    function(e, r, t) {
      ...
      function f(e, r, t) {
        var u = o(e),
          f = o(r),
          a = Math.max(u[1], f[1]);
        if (0 === a) return i(Number(e), Number(r), t, 1);
        var c = Math.pow(10, a);
        return u[1] !== f[1] && (u[1] > f[1] ? (f[0] += n(u[1] - f[1])) : (u[0] += n(f[1] - u[1]))), i(Number(u[0]), Number(f[0]), t, c);
      }
      function a(e, r) {
        return f(e, r, '+');
      }
      ...
      e.exports = { add: a, sub: c, mul: p, div: s, round: l };
    },
    function(e, r, t) {
      'use strict';
      function n(e) {
        for (var r = 0, t = void 0, n = [], u = d; e[r]; ) {
          t = e[r];
          var o = b[t];
          if (o) n.push({ type: o }), (u = d);
          else if (/[0-9]/.test(t)) {
            if (u == d) n.push({ type: i, value: t }), (u = y);
            else if (u == y || u == h) {
              var f = n[n.length - 1];
              f.value += t;
            }
      ...
      function u(e) {
        ...
        function u() {
          var e = 0,
            t = !1;
          if ((r(), b.type == a && ((t = !0), r()), b.type == i)) e = b.value;
          else if (b.type == s && ((e = d()), r(), b.type != l)) throw '缺少 ) ';
